...
mod tests {
    ...
    #[test]
    fn serialize_deserialized_schema_components() {
    ...
    #[test]
    fn serialize_deserialized_object_component() {
        let prop = Object::new()
            .property("name", Object::new().schema_type(BasicType::String))
            .required("name");
    ...
    #[test]
    fn serialize_deserialized_property() {
    ...
    fn serialize_deserialize_schema_array_ref_or_t() {
        let ref_or_schema = RefOr::Type(Schema::Array(Array::new().items(RefOr::Type(Schema::Object(
            Box::new(Object::new().property("element", RefOr::Ref(Ref::new("#/test")))),
        )))));
    ...
    #[test]
    fn deserialize_serialize_one_of_default_type() {
        let a = OneOf::new()
            .item(Schema::Array(Array::new().items(RefOr::Type(Schema::object(
                Object::new().property("element", RefOr::Ref(Ref::new("#/test"))),
            )))))
        ...
        let serialized_json = serde_json::to_string(&b).expect("serialized json");

        assert_eq!(serialized_json, serialized_json);
    }
    ...
    fn test_additional_properties_from_ref_or() {
        let additional_properties = AdditionalProperties::from(RefOr::Type(Schema::Object(Box::default())));
        assert_json_eq!(
